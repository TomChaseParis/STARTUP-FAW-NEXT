...
const questions: Q[] = [
  ...
  {
    text: "Je bois du thé avec du miel et je mange une tartine de pain avec de la confiture, et des céréales.",
    acceptableAnswers: [
      "Qu’est-ce que tu prends pour ton petit déjeuner ?",
      "Que prends-tu pour ton petit déjeuner ?",
    ],
  },
  {
    text: "Je quitte la maison à 10 heures moins le quart.",
    acceptableAnswers: [
      "À quelle heure est-ce que tu quittes la maison ?",
      "À quelle heure quittes-tu la maison ?",
    ],
  },
  {
    text: "Gaston ? C’est mon chat !",
    acceptableAnswers: ["Qui est Gaston ?", "Gaston, c’est qui ?"],
  },
  {
    text: "Je vais au travail en métro.",
    acceptableAnswers: [
  ...
  {
    text: "Je mets à peu près 25 minutes.",
    acceptableAnswers: [
      "Combien de temps est-ce que tu mets pour aller au travail ?",
      "Combien de temps mets-tu pour aller au travail ?",
    ],
  },
  {
    text: "Je commence à travailler à 10 heures et quart.",
    acceptableAnswers: [
  ...
  {
    text: "Je suis professeur de danse orientale.",
    acceptableAnswers: [
  ...
  {
    text: "Je travaille dans cette école depuis 8 ans.",
    acceptableAnswers: [
      "Depuis combien de temps est-ce que tu travailles dans cette école ?",
      "Depuis combien de temps travailles-tu dans cette école ?",
    ],
  },
  {
    text: "Je déjeune avec mon collègue Jamal ou certains de mes élèves.",
    acceptableAnswers: [
      "Avec qui est-ce que tu déjeunes ?",
      "Avec qui déjeunes-tu ?",
    ],
  },
  {
    text: "Je déjeune dans une petite brasserie du coin.",
    acceptableAnswers: ["Où est-ce que tu déjeunes ?", "Où déjeunes-tu ?"],
  },
  {
    text: "Après le restaurant ? Je vais parfois m’asseoir dans un parc pour lire un bon livre et m’aérer l’esprit.",
    acceptableAnswers: [
      "Qu’est-ce que tu fais après le restaurant ?",
      "Que fais-tu après le restaurant ?",
    ],
  },
  {
    text: "Je donne des cours jusqu’à 4 heures de l’après-midi.",
    acceptableAnswers: [
      "Jusqu’à quelle heure est-ce que tu donnes des cours ?",
      "Jusqu’à quelle heure donnes-tu des cours ?",
    ],
  },
  {
    text: "Après le travail ? Je me promène un peu et je vais faire des courses.",
    acceptableAnswers: [
  ...
  {
    text: "Non. Je vis seule avec mon chat Gaston.",
    acceptableAnswers: [
  ...
  {
    text: "Non. Je mange des pâtes à la mozzarella seulement le jeudi soir.",
    acceptableAnswers: [
      "Est-ce que tu manges des pâtes à la mozzarella tous les soirs ?",
      "Tu manges des pâtes à la mozzarella tous les soirs ?",
    ],
  },
  {
    text: "La semaine dernière ? Je suis allée voir un spectacle de patinage artistique.",
    acceptableAnswers: [
  ...
  {
    text: "Avant d’aller au lit, j’appelle ma mère ou mon frère pour prendre de leurs nouvelles.",
    acceptableAnswers: [
      "Qui est-ce que tu appelles avant d’aller au lit ?",
      "Qui appelles-tu avant d’aller au lit ?",
    ],
  },
  {
    text: "Je me mets au lit vers 11 heures.",
    acceptableAnswers: [
      "Vers quelle heure est-ce que tu te mets au lit ?",
      "Vers quelle heure te mets-tu au lit ?",
    ],
  },
  {
    text: "Avant de dormir ? Je lis un livre pendant une petite demi-heure.",
    acceptableAnswers: [
  ...
  const evaluate = (input: string) => {
    ...
    speakText(
      ok
        ...
        : `Dommage. Par exemple : ${q.acceptableAnswers[0]}.`,
    );
    setHistory((h) => [
      ...h,
      { q: q.text, user, correct: ok, expected: q.acceptableAnswers },
    ]);
  };
  ...
  return (
    <section className="bg-white">
      <div className="mx-auto max-w-3xl pb-16 pt-10">
        ...
        <div className="mx-auto max-w-2xl rounded-xl bg-white p-5 shadow-lg ring-1 ring-black/5">
          {!started ? (
            <div className="text-center">
              <p className="text-black/80">
                Appuie sur <strong>Lancer l’exercice</strong>. L’énoncé sera lu
                à voix haute.
              </p>
              <button
            ...
            <>
              <div className="mb-4">
                ...
                {!hasAnswered && (
                  <button
                    ...
                    className="mt-2 inline-flex items-center justify-center rounded-md bg-amber-500 px-3 py-1.5 font-semibold text-black hover:bg-amber-400"
                  >
                    🔊 Relire l’énoncé
                  </button>
                )}
              ...
              <p className="mt-3 min-h-[1.5rem] text-sm text-black">
                {feedback}
              </p>
        ...
        {history.length > 0 && (
          <div className="mx-auto mt-8 max-w-2xl">
            <h3 className="mb-3 font-semibold text-black">Historique</h3>
            <ul className="space-y-3">
              {history.map((h, i) => (
                ...
                >
                  ...
                  {!h.correct && (
                    <p className="mt-1 text-black">
                      Exemples attendus : « {h.expected[0]} » ou «{" "}
                      {h.expected[1]} ».
                    </p>
                  )}
                </li>
