...
export type CharacterPresentationSpeechItem = {
  id: number;
  audio: string;
  sentences: SpeechSentence[];
};

export const characterPresentationSpeechData: CharacterPresentationSpeechItem[] =
  [
    {
      id: 1,
...

    {
      ...
      sentences: [
        ...
        {
          text: "Elle va très bien depuis que son mari est mort.",
          start: 17.4,
        },
      ],
    },

    {
      ...
      sentences: [
        {
          text: "Nous avons dix-sept ans, trois mois et deux jours.",
          start: 0,
        },
...

    {
      ...
      sentences: [
        ...
        {
          text: "Vous êtes ridicules avec vos lunettes et votre crème solaire.",
          start: 23,
        },
      ],
    },
