...
export const quizData: Question[] = [
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q2.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q3.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "La paella ne se prépare pas comme ça.",
      },
      {
        id: "B",
        label:
          "Avec du riz, du chorizo, du poulet et/ou des fruits de mer",
        isCorrect: true,
        explanationCorrect:
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ce n’est absolument pas une paella.",
      },
    ],
  },

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q4.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q5.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ils ne prennent pas l’avion pour aller au travail.",
      },
      {
        id: "D",
        label: "À pied",
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ils ne marchent pas jusqu'au travail.",
      },
    ],
  },

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q6.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q7.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q8.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    id: 9,
    question:
      "Qui a été le dernier président de l’URSS ?",
    image:
      "/images/courses/elementary/questions-reponses/Q9.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "C’est une chanteuse, pas une présidente.",
      },
      {
        id: "B",
        label: "Gorbatchev",
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Staline est mort bien avant la fin de l’URSS.",
      },
      {
        id: "D",
        label: "Brejnev",
        ...
        explanationCorrect: "",
        explanationWrong:
          "Brejnev n’a pas été le dernier dirigeant.",
      },
    ],
  },

  {
    id: 10,
    question:
      "Quel instrument est-ce qu’il joue ?",
    image:
      "/images/courses/elementary/questions-reponses/Q10.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    id: 11,
    question:
      "Pourquoi est-ce que les oiseaux chantent ?",
    image:
      "/images/courses/elementary/questions-reponses/Q11.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      ...
      },
      {
        ...
        isCorrect: true,
        explanationCorrect:
          "Les oiseaux chantent pour communiquer.",
        explanationWrong: "",
      },
      {
        id: "D",
...

  {
    id: 12,
    question:
      "Quel moment historique illustre cette photo ?",
    image:
      "/images/courses/elementary/questions-reponses/Q12.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "La Tour Eiffel n’a jamais été détruite.",
      },
      {
        id: "D",
        label:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q13.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
...

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q14.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ils n’habitent pas sur un bateau.",
      },
    ],
  },

  {
    ...
    image:
      "/images/courses/elementary/questions-reponses/Q15.png",
    teacherImage:
      "/images/courses/teacher/jeanbulle.png",
    teacherAudioQuestion:
    ...
    choices: [
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ce n’est pas un objet extraterrestre.",
      },
      {
        id: "B",
      ...
      },
      {
        ...
        explanationCorrect: "",
        explanationWrong:
          "Ce ne sont pas des toilettes portatives.",
      },
      {
        id: "D",
