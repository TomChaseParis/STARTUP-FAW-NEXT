...
export class ProgressEngine {
  ...
  public createActivity(
     ...
     * =========================================================
     *
     * L'activité peut avoir été créée avant qu'un nouvel
     * exercice soit ajouté dans activityX.ts.
     *
     * On conserve donc toute la progression existante
     * et on ajoute uniquement les exercices manquants.
     */
    ...
    if (existing) {
      ...
      exerciseIds.forEach(
        (exerciseId, index) => {
          const existingExercise =
            existing.exercises[exerciseId];

          /*
           * L'exercice existe déjà :
           * on ne touche surtout pas à sa progression.
           */
          ...
          /*
           * Nouvel exercice :
           * il est disponible uniquement si c'est
           * le premier exercice.
           *
           * Sinon il reste verrouillé jusqu'à ce
           * que l'exercice précédent soit terminé.
           */
      ...
      /*
       * Si de nouveaux exercices ont été ajoutés,
  ...
  public submitScore(
    ...
    /*
     * =========================================================
     * DÉVERROUILLAGE DE L'EXERCICE SUIVANT
     * =========================================================
     */
