...
const Exercice2: React.FC = () => {
  ...
  return (
    <section className="bg-white border-t border-black/10">
      <div className="container max-w-3xl mx-auto pt-12 pb-16">
        {/* Titre & consigne */}
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-black">EXERCICE 2</h2>
          <p className="text-black/80 mt-2">
            <strong>Consigne :</strong> Transformez l’intégralité du texte en passant de <em>« je »</em> à <em>« elle »</em> et en faisant toutes les transformations nécessaires.
          </p>
          <p className="text-black/60 italic mt-2">
            Exemple : « Je me lève seulement à 9 heures. » → « Elle se lève seulement à 9 heures. »
          </p>
        </div>
