  ...
  const gaps = [
    {
      ...
      parts: [
        ...
        { type: "text", value: " loin. Tous les jours. Ils partent en train de bonne heure et " },
    ...
    },
    {
      ...
      parts: [
        ...
        { type: "input", answer: "ont décidé", hint: "décider (passé composé)" },
    ...
    },
    {
      ...
      parts: [
        ...
        { type: "text", value: " à papa : « Quand pourrons-nous le visiter ? »" }
      ]
    },
    {
      id: 6,
    ...
    <section className="mt-12 bg-white pb-20">
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="rounded-xl bg-white p-8 shadow-lg ring-1 ring-black/5">
          <h3 className="mb-6 text-xl font-semibold text-black">Complète le texte :</h3>
                    ...
                    if (part.type === "input") {
                      const globalIndex =
                        gaps
                          ...
                          .reduce(
                            (sum, s) =>
                              sum + s.parts.filter((p) => p.type === "input").length,
                            0
                          ) + inputIndex;
                      ...
                      return (
                        <span key={partIndex} className="mx-2 inline-flex flex-col">
                          <input
                            type="text"
                            value={val}
                            onChange={(e) =>
            ...
            {!showCorrection && (
              <button
                ...
                className={`
                  ...
                  ${
                    allAnswered
                      ? "bg-black hover:bg-black/90 active:scale-95 hover:shadow-xl"
