      ...
      <div className="container mx-auto max-w-5xl text-center">
        ...
        <div className="mx-auto mb-10 max-w-5xl rounded-xl bg-amber-50 p-6 text-left shadow-sm ring-1 ring-amber-200">
          <h3 className="mb-3 text-lg font-semibold text-black">
            ✍️ Exercice 1 — Compléter le dialogue
          </h3>

          <p className="leading-relaxed text-black/80">
            Écoutez à nouveau le dialogue et complétez les verbes à la bonne forme.
          </p>
        </div>
        ...
        <div className="rounded-xl bg-white p-8 text-left shadow-lg ring-1 ring-black/5 transition-all duration-300">
              ...
              return (
                <p
                  ...
                  className={`
                    ...
                    ${answers[i] ? "bg-amber-50/60 border-l-4 border-amber-400 pl-3 rounded-md" : ""}
                  `}
                >
                  {gap.before}
          ...
          <div className="mt-10 flex justify-center gap-4">
            ...
            <button
              ...
              className="rounded-xl bg-slate-100 px-6 py-3 text-slate-700 hover:bg-slate-200 shadow"
            >
              Effacer
            </button>
          </div>
