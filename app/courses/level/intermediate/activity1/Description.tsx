          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div>
              ...
              <ul className="list-disc space-y-1 pl-5 text-black/80">
                <li>Évoquer ses souvenirs d’enfance</li>
                <li>Parler de ses vacances</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc space-y-1 pl-5 text-black/80">
                ...
                <li>Vocabulaire de la mer et de la famille</li>
            ...
            <div>
              ...
              <p className="text-black/80">
                ...
                <span className="italic">
                  {" "}
                  « j’allais », « tu allais », « il / elle / on allait », etc.
                </span>
              </p>
            </div>
      ...
      <div className="container mt-20">
        <div className="flex justify-center">
          <div className="relative w-full max-w-5xl overflow-hidden rounded-xl shadow-lg ring-1 ring-black/5">
            <Image
              src="/images/courses/intermediate/vacancespicheader.png" // à adapter à ton image
